package com.zdan.gbcpicturebackend.manager.websocket;

import cn.hutool.core.collection.CollUtil;
import cn.hutool.json.JSONUtil;
import com.fasterxml.jackson.databind.ObjectMapper;
import com.zdan.gbcpicturebackend.manager.websocket.disruptor.PictureEditEventProducer;
import com.zdan.gbcpicturebackend.manager.websocket.model.PictureEditActionEnum;
import com.zdan.gbcpicturebackend.manager.websocket.model.PictureEditMessageTypeEnum;
import com.zdan.gbcpicturebackend.manager.websocket.model.PictureEditRequestMessage;
import com.zdan.gbcpicturebackend.manager.websocket.model.PictureEditResponseMessage;
...
public class PictureEditHandler extends TextWebSocketHandler {
    ...
    public void afterConnectionEstablished(WebSocketSession session) throws Exception {
        ...
        pictureEditResponseMessage.setEditUser(userService.getUserVO(this.pictureEditingUsers.get(pictureId)));
    ...
    public void handleEnterEditMessage(PictureEditRequestMessage pictureEditRequestMessage,
        ...
        if (editUser == null) {
            ...
            pictureEditResponseMessage.setEditUser(userService.getUserVO(user));
            // 广播给所有的用户
    ...
    public void handleEditActionMessage(PictureEditRequestMessage pictureEditRequestMessage,
        ...
        if (editUser != null && editUser.equals(user)) {
            ...
            if (editActionEnum != null) {
                ...
                responseMessage.setEditUser(userService.getUserVO(user));
    ...
    public void handleSaveEditMessage(PictureEditRequestMessage pictureEditRequestMessage,
        ...
        if (editUser != null && editUser.equals(user)) {
            ...
            pictureEditResponseMessage.setPicUrl(pictureService.getById(pictureId).getUrl());
