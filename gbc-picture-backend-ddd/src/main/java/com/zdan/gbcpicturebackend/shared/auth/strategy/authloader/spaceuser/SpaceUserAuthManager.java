...
import com.zdan.gbcpicturebackend.shared.auth.model.SpaceUserAuthConfig;
import com.zdan.gbcpicturebackend.shared.auth.model.SpaceUserPermissionConstant;
import com.zdan.gbcpicturebackend.shared.auth.model.SpaceUserRole;
    ...
    public List<String> getPermissionList(Space space, User loginUser) {
        ...
        switch (spaceTypeEnum) {
            ...
            case TEAM:
                ...
                SpaceUser spaceUser = spaceUserDomainService.getSpaceUser(space.getId(), loginUser.getId());
                if (spaceUser == null) {
                    return new ArrayList<>();
                } else {
