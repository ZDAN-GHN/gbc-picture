...
/** getPictureOutPaintingTaskResponse GET /api/picture/out_painting/get_response */
export async function getPictureOutPaintingTaskResponseUsingGet(
  // 叠加生成的Param类型 (非body参数swagger默认没有生成对象)
  params: API.getPictureOutPaintingTaskResponseUsingGETParams,
  options?: { [key: string]: any }
) {
  return request<API.BaseResponseGetOutPaintingTaskResponse_>(
    '/api/picture/out_painting/get_response',
    {
      method: 'GET',
      params: {
        ...params,
